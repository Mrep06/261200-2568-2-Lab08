...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        Pen Tom = new Pen("red",0,0);
        Pen Tom1 = new Pen("blue",100,100);
        Pen Tom2 = new Pen("yellow",-100,100);
        Pen Tom3 = new Pen("green",100,-100);
        Pen Tom4 = new Pen("violet",-100,-100);
        Thread mythread = new Thread(Tom);
        Thread mythread1 = new Thread(Tom1);
        Thread mythread2 = new Thread(Tom2);
        Thread mythread3 = new Thread(Tom3);
        Thread mythread4 = new Thread(Tom4);
        mythread.start();
        mythread1.start();
        mythread2.start();
        mythread3.start();
